...
(function($) {
	...
	$("#num_pos").text(stats.num_pos);
	$("#num_neg").text(stats.num_neg);
	$("#avg_score").text(parseInt(100 * stats.avg_score) + "%");
  $("#top5").html("1. " + stats.top_5[0] + "<br>" + "2. " + stats.top_5[1] + "<br>" +
                  "3. " + stats.top_5[2] + "<br>" + "4. " + stats.top_5[3] + "<br>" +
                  "5. " + stats.top_5[4]);
      }
      xhr.open("GET", "user_stats/test_user", true);
      xhr.send();
    });
    ...
    function getRequest(String id) {
      var xhr = new XMLHttpRequest();
   		xhr.onreadystatechange = function() {
             ...
             returnitem = parseint(dict[id]);
   			}
   		}
   		xhr.open("GET", "http://10.194.223.134:5000/user_stats/test_user", true);
   		xhr.send();
   	}*/
